window.addEventListener("load",()=>{
    ...
    function initializeScene(){
        ...
        const gap = 3;
        const cycyleHeight = totalSlides * (slideHeight + gap);
        ...
        function updateTexture(offset = 0){
            ...
            for(let i = -extraSlides; i < totalSlides + extraSlides; i++) {
                ...
                slideY += offset * cycyleHeight;

                const textureY = (slideY / cycyleHeight) * textureCanvas.height;
                ...
                const slideRect = {
    x: textureCanvas.width * 0.05,   // ✅ Sahi
    y: wrappedY,
    width: textureCanvas.width * 0.9,
    height: (slideHeight / cycyleHeight) * textureCanvas.height,
};
